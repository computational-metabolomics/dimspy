...
class WorkflowTestCase(unittest.TestCase):
    ...
    def test_process_scans_mzml_zip(self):
        pls = process_scans(os.path.join(self.path_test_data, "MTBLS79_mzml_triplicate.zip"), function_noise="median", snr_thres=3.0, nscans=1, ppm=2.0, min_fraction=None, rsd_thres=None, filelist=os.path.join(self.path_test_data, "filelist_mzml_triplicate.txt"), subset_scan_events=None, block_size=2000, ncpus=None)
        ...
        pls = process_scans(os.path.join(self.path_test_data, "MTBLS79_mzml_triplicate.zip"), function_noise="median", snr_thres=3.0, nscans=3, ppm=2.0, min_fraction=None, rsd_thres=None, filelist=os.path.join(self.path_test_data, "filelist_mzml_triplicate.txt"), subset_scan_events=None, block_size=2000, ncpus=None)
    ...
    def test_process_scans_raw_path(self):
        pls = process_scans(os.path.join(self.path_test_data, "raw"), function_noise="median", snr_thres=3.0, nscans=1, ppm=2.0, min_fraction=None, rsd_thres=None, filelist=os.path.join(self.path_test_data, "filelist_raw_triplicate.txt"), subset_scan_events=None, block_size=2000, ncpus=None)
    ...
    def test_replicate_filter(self):
        ...
        pls_rf = replicate_filter(pls, ppm=2.0, replicates=3, min_peaks=2, rsd_thres=None, filelist=os.path.join(self.path_test_data, "filelist_mzml_triplicate.txt"), block_size=2000, ncpus=None)
    ...
    def test_align_samples(self):
        #pls = process_scans(os.path.join(self.path_test_data, "MTBLS79_mzml_subset.zip"), "median", 3.0, 1, 2.0, min_fraction=None, rsd_thres=None, filelist=os.path.join(self.path_test_data, "filelist_mzml_subset.txt"), subset_scan_events=None, block_size=2000, ncpus=None)
        #pls_rf = replicate_filter(pls, ppm=2.0, replicates=3, min_peaks=2, rsd_thres=None, filelist=None, block_size=2000, ncpus=None)
        #save_peaklists_as_hdf5(pls_rf, os.path.join(self.path_test_data, "MTBLS79_mzml_subset_rf.hdf5"))
        pls_rf = load_peaklists_from_hdf5(os.path.join(self.path_test_data, "MTBLS79_mzml_subset_rf.hdf5"))
        pm = align_samples(pls_rf, ppm=2.0, filelist=None, block_size=2000, ncpus=None)
