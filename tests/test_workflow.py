...
class WorkflowTestCase(unittest.TestCase):
    ...
    def test_process_scans_mzml_zip(self):
        pls = process_scans(os.path.join(self.path_test_data, "MTBLS79_mzml_triplicates.zip"), function_noise="median", snr_thres=3.0, nscans=1, ppm=2.0, min_fraction=None, rsd_thres=None, filelist=os.path.join(self.path_test_data, "filelist_mzml_triplicates.txt"), filter_scan_events=None, block_size=2000, ncpus=None)
        ...
        self.assertEqual([pl.to_str()[0:500] for pl in pls], [pl.to_str()[0:500] for pl in pls_comp])
        self.assertEqual([pl.to_str() for pl in pls], [pl.to_str() for pl in pls_comp])

        pls = process_scans(os.path.join(self.path_test_data, "MTBLS79_mzml_triplicates.zip"), function_noise="median", snr_thres=3.0, nscans=3, ppm=2.0, min_fraction=None, rsd_thres=None, filelist=os.path.join(self.path_test_data, "filelist_mzml_triplicates.txt"), filter_scan_events=None, block_size=2000, ncpus=None)
    ...
    def test_process_scans_raw_path(self):
        pls = process_scans(os.path.join(self.path_test_data, "raw"), function_noise="median", snr_thres=3.0, nscans=1, ppm=2.0, min_fraction=None, rsd_thres=None, filelist=os.path.join(self.path_test_data, "filelist_raw_triplicates.txt"), filter_scan_events=None, block_size=2000, ncpus=None)
    ...
    def test_replicate_filter(self):
        ...
        pls_rf_comp = load_peaklists_from_hdf5(os.path.join(self.path_test_data, "MTBLS79_mzml_triplicate_single_scan_rf.hdf5"))
        self.assertEqual([pl.to_str()[0:500] for pl in pls_rf], [pl.to_str()[0:500] for pl in pls_rf_comp])
        ...
        pls_rf_comp = load_peaklists_from_hdf5(os.path.join(self.path_test_data, "MTBLS79_mzml_triplicate_multiple_scans_rf.hdf5"))
        self.assertEqual([pl.to_str()[0:500] for pl in pls_rf], [pl.to_str()[0:500] for pl in pls_rf_comp])
        self.assertEqual([pl.to_str() for pl in pls_rf], [pl.to_str() for pl in pls_rf_comp])

    def test_align_samples(self):
        pls = process_scans(os.path.join(self.path_test_data, "MTBLS79_mzml_triplicates.zip"), "median", 3.0, 1, 2.0, min_fraction=None, rsd_thres=None, filelist=os.path.join(self.path_test_data, "filelist_mzml_triplicates.txt"), filter_scan_events=None, block_size=2000, ncpus=None)
