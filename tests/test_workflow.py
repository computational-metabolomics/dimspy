...
class WorkflowTestCase(unittest.TestCase):
    ...
    def test_process_scans_mzml_zip(self):
        ...
        with open(os.path.join("test_results", "test_pm_mzml.txt"), "w") as out: out.write(pls[0].to_str("\t"))
        with open(os.path.join("test_results", "test_pm_mzml_comp.txt"), "w") as out: out.write(pls_comp[0].to_str("\t"))
        ...
        # save_peaklists_as_hdf5(pls, os.path.join(self.path_test_data, "MTBLS79_mzml_frac_rsd.hdf5"))
        pls_comp = load_peaklists_from_hdf5(os.path.join(self.path_test_data, "MTBLS79_mzml_frac_rsd.hdf5"))
        with open(os.path.join("test_results", "test_pl_frac_rsd.txt"), "w") as out: out.write(pls[0].to_str("\t"))
        with open(os.path.join("test_results", "test_pl_frac_rsd_comp.txt"), "w") as out: out.write(pls_comp[0].to_str("\t"))
        self.assertEqual([pl.to_str() for pl in pls], [pl.to_str() for pl in pls_comp])
    ...
    def test_process_scans_raw_path(self):
        ...
        with open(os.path.join("test_results", "test_pl_raw.txt"), "w") as out: out.write(pls[0].to_str("\t"))
        with open(os.path.join("test_results", "test_pl_comp_raw.txt"), "w") as out: out.write(pls_comp[0].to_str("\t"))
        self.assertEqual([pl.to_str() for pl in pls], [pl.to_str() for pl in pls_comp])

    def test_replicate_filter(self):
        # pls = process_scans(os.path.join(self.path_test_data, "MTBLS79_mzml_triplicates.zip"), function_noise="median",
        #                     snr_thres=3.0, min_scans=1, ppm=2.0, min_fraction=None, rsd_thres=None,
        ...
        with open(os.path.join("test_results", "test_pl_rf.txt"), "w") as out: out.write(pls_rf[0].to_str("\t"))
        with open(os.path.join("test_results", "test_pl_rf_comp.txt"), "w") as out: out.write(pls_rf_comp[0].to_str("\t"))
        self.assertEqual([pl.to_str() for pl in pls_rf], [pl.to_str() for pl in pls_rf_comp])
    ...
    def test_align_samples(self):
        ...
        with open(os.path.join("test_results", "test_pm_as.txt"), "w") as out: out.write(pm.to_str())
        with open(os.path.join("test_results", "test_pm_as_comp.txt"), "w") as out: out.write(pm_comp.to_str())
    ...
    def test_blank_filter(self):
        ...
        with open(os.path.join("test_results", "test_pm_bf.txt"), "w") as out: out.write(pm.to_str())
        with open(os.path.join("test_results", "test_pm_bf_comp.txt"), "w") as out: out.write(pm_comp.to_str())
    ...
    def test_sample_filter(self):
        ...
        with open(os.path.join("test_results", "test_pm_sf.txt"), "w") as out: out.write(pm.to_str())
        with open(os.path.join("test_results", "test_pm_sf_comp.txt"), "w") as out: out.write(pm_comp.to_str())
    ...
    def test_merge_peaklists(self):
        ...
        #                            block_size=2000, ncpus=None)
        #
        # pls_rep_02 = process_scans(os.path.join(self.path_test_data, "raw", "batch04_QC17_rep02_263.RAW"),
        #                            function_noise="noise_packets", snr_thres=10.0, min_scans=1, ppm=2.0,
        #                            min_fraction=None, rsd_thres=None, filelist=None, filter_scan_events=None,
        #                            block_size=2000, ncpus=None)
        #
