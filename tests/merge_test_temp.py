...
peaks1 = process_scans(source='/mnt/hgfs/DATA/nearline_dims_check/sample', function_noise="median",
                            snr_thres=3.0, ppm=2.0, min_fraction=0.7, rsd_thres=None,
...
pm = align_samples(merge_peaklists,  ppm=2)
